...
const Footer = () => {
    return (
        <footer className="footer items-center justify-items-center p-10 drop-shadow-xl">
            <aside className="items-center grid-flow-col">
                ...
                <p className="text-base lg:text-2xl font-semibold text-slate-700">Copyright © 2023 - All right reserved by Kamal Hossain</p>
            </aside>
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href="https://twitter.com/kamalfca?t=2W9-R03kA5oiBw1P_dXrzg&s=09&fbclid=IwAR2BkAy9DWokLP8zMgvgcL-IeNNefkeCRToyHpNgx4yoNBJhHuyYyX81NY8"><BsTwitter className="h-12 w-12"/></a>
                <a href="https://www.youtube.com/@Kamalsworlds"><BsYoutube className="h-12 w-12"/></a>
                <a href="https://www.facebook.com/profile.php?id=100005829730160"><MdFacebook className="h-12 w-12"/></a>
            </nav>
        </footer>
    );
};
